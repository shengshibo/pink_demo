...
export default {
  ...
  methods: {
    handleCollection () {
      const isCollected = this.isCollected = !this.isCollected
...
<style>
  .detailContainer {display: flex;flex-direction: column;}
  .detail_header {width: 100%;height: 460rpx;}
  .avatar_date {padding: 10rpx;}
  .avatar_date img {width: 64rpx;height: 64rpx;vertical-align: middle;}
  .avatar_date span {font-size: 28rpx;margin-left: 6rpx;}
  .company {font-size: 32rpx;font-weight: bold;padding: 10rpx;}
  .collection_share_container {position: relative;}
  .collection_share {float: right;margin-right: 30rpx;}
  .collection_share img {width: 90rpx;height: 90rpx;margin-right: 20rpx;}
  .line {width: 90%;height: 4rpx;background: pink;position: absolute;top: 45rpx;left: 5%;z-index: -1;}
  .content {font-size: 32rpx;text-indent: 32rpx;letter-spacing: 3rpx;line-height: 50rpx;}
  .music_img {width: 60rpx;height: 60rpx;top: 200rpx;position: absolute;left: 50%;margin-left: -30rpx;}
</style>